                ...
                <section class="vh-100 d-flex justify-content-center align-items-center my-5">
                    <div class="card custom-form-width">
                        <div class="card-body">
                            ...
                            <form action="/HFManagementSystem/change"  method="post">
                                <div class="form-group">
                                    <label for="oldpassword">Mật Khẩu Cũ <span class="note">*</span></label>
                                    <input type="password" class="form-control" id="code" value="${oldpass}" name="oldpassword" required
                                       placeholder="Mật khẩu cũ...">
                            </div>
                            <div class="form-group">
                                <label for="newpassword">Mật Khẩu Mới <span class="note">*</span></label>
                                <input type="password" class="form-control" id="password" value="${newpass}" name="newpassword" required
                                       placeholder="Nhập mật khẩu mới...">
                            </div>
                            <div class="form-group">
                                <label for="confirmPassword">Xác Nhận Mật Khẩu Mới <span class="note">*</span></label>
                                <input type="password" class="form-control" id="confirmPassword" value="${confirmpass}" name="confirmPassword"
